export const config = {
  api: {
    ...
    kafkaMonitor: import.meta.env.VITE_KAFKA_MONITOR_URL || 'http://localhost:8088',
    incidentService: import.meta.env.VITE_INCIDENT_SERVICE_URL || 'http://localhost:8089',
    aiService: import.meta.env.VITE_AI_SERVICE_URL || 'http://localhost:8090',
  },
  app: {
